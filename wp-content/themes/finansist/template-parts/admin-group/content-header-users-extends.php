  <thead>
    <tr>
      ...
      <th scope="col" class="centered"><?= esc_html('Возврат инвестиций (портфель)')?></th>
      <th scope="col" class="centered"><?= esc_html('Вложено из портфеля')?></th>
      <th scope="col" class="centered"><?= esc_html('Вложено сверх')?></th>
      <th scope="col" class="centered"><?= esc_html('Капитал не вложен')?></th>
      <th scope="col" class="centered"><?= esc_html('Портфель')?></th>
    </tr>
  </thead>