...
if (in_array('group', $view) && (current_user_can('project_manager') || current_user_can('manager') || current_user_can('administrator') || current_user_can('helper_manager') ) && $groupName !== '') {
