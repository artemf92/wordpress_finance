...
function xsbf_load_css() {
	...
	wp_register_style('bootstrap-utilities', get_template_directory_uri() . '/bootstrap/css/bootstrap-utilities.min.css', array(), '3.3.6', 'all' );
...
function xsbf_load_js() {
	...
	wp_enqueue_script( 'bootstrap-bundle', get_template_directory_uri() . '/bootstrap/js/bootstrap.bundle.min.js', array('jquery'), '3.3.6', true );
